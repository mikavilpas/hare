...
_mobile users may need to click the code once to have a copy button show up_
...
0. Open https://sakura-paris.org/dict/ and go to its settings

The settings can be found under the cog icon.

0. Find the place where it says `カスタマイズ JS: ` and paste the previously copied code there
0. Close the settings window
0. Reload the page
